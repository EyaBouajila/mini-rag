...
from ..VectorDBEnums import (PgVectorDistanceMethodEnums, 
                             PgVectorIndexTypeEnums, PgVectorTableSchemeEnums, DistanceMethodEnums)
...
class PGVectorProvider(VectorDBInterface):
    def __init__(self, db_client, default_vector_size: int = 1536, distance_method: str = None, index_threshold: int = 100):
